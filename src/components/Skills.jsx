...
const skillCategories = [
  {
    ...
    code: "L1-DEV",
    skills: [
      { name: "Python (intermediate)", icon: <FaPython className="text-[#3776AB]" /> },
      { name: "Java (beginner)", icon: <FaJava className="text-[#E76F00]" /> },
      { name: "C (intermediate)", icon: <SiC className="text-[#A8B9CC]" /> },
      { name: "JavaScript (beginner)", icon: <FaJs className="text-[#F7DF1E]" /> },
    ],
  },
  {
    title: "Stack_Modules",
    code: "L2-WEB",
    skills: [
      { name: "React (beginner)", icon: <SiReact className="text-[#61DAFB]" /> },
      { name: "Node.js (intermediate)", icon: <SiNodedotjs className="text-[#339933]" /> },
      { name: "MongoDB (beginner)", icon: <SiMongodb className="text-[#47A248]" /> },
      { name: "HTML/CSS (intermediate)", icon: <FaHtml5 className="text-[#E34F26]" /> },
    ],
  },
  {
    title: "Logic_Engines",
    code: "L3-AUTO",
    skills: [
      { name: "Selenium (intermediate)", icon: <SiSelenium className="text-[#43B02A]" /> },
      { name: "NumPy (beginner)", icon: <SiNumpy className="text-[#013243]" /> },
      { name: "RobotFrame (intermediate)", icon: <FaRobot className="text-white" /> },
      { name: "Matplotlib (beginner)", icon: <FaCode className="text-[#11557C]" /> },
    ],
  },
  {
    ...
    code: "L4-OPS",
    skills: [
      { name: "MySQL (intermediate)", icon: <SiMysql className="text-[#4479A1]" /> },
      { name: "GitHub (intermediate)", icon: <FaGithub className="text-white" /> },
      { name: "VS Code (intermediate)", icon: <FaCode className="text-[#007ACC]" /> },
      { name: "Pycharm (intermediate)", icon: <SiPycharm className="text-[#21D789]" /> },
    ],
  }
];
